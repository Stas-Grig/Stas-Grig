...
- [Методы оптимизации](https://github.com/Stas-Grig/Optimization_methos) — модуль для поиска минимумов функций с одномерными и многомерными методами оптимизации.
- [Решение систем дифференциальных уравнений](https://github.com/Stas-Grig/Solver_of_systems_of_differential-equations) — Python-модуль для численного решения ОДУ.
